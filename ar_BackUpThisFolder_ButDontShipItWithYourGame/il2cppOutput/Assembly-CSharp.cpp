...
{
	// UnityEngine.XR.ARFoundation.ARRaycastManager Navigation::arRaycastManager
	ARRaycastManager_tD9459374F0F5BD9E2E4A8A1C665E7F33F9C2EE44* ___arRaycastManager_4;
	// UnityEngine.XR.ARFoundation.ARPlaneManager Navigation::arPlaneManager
	ARPlaneManager_t9DA6C512BDCFFBEE8B3DAA7170EB3BFFDE26A928* ___arPlaneManager_5;
	// UnityEngine.Vector2 Navigation::centerPos
	Vector2_t1FD6F485C871E832B347AB2DC8CBA08B739D8DF7 ___centerPos_6;
	// System.Collections.Generic.List`1<UnityEngine.XR.ARFoundation.ARRaycastHit> Navigation::hits
...
struct Navigation_t9F99316B323A490310A05E96F2C7460595A0EC02_StaticFields
{
	...
	float ___magneticHeading_8;
	// System.Single Navigation::trueHeading
	float ___trueHeading_9;
};
...
#pragma clang diagnostic ignored "-Wunused-variable"
#endif
// System.Void Navigation::Awake()
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void Navigation_Awake_m0AB5C85EAAD860E9118C80D26C64002914A554F4 (Navigation_t9F99316B323A490310A05E96F2C7460595A0EC02* __this, const RuntimeMethod* method) 
{
	{
		...
		NullCheck(L_1);
		Compass_set_enabled_m26DFB64F789DA4B875359E8CE1C3E9E2270CFCA9(L_1, (bool)1, NULL);
		// }
		return;
	}
}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void Navigation_Update_m8B9C2F786DCEDBB65BD03869DB567A1773B0B9ED (Navigation_t9F99316B323A490310A05E96F2C7460595A0EC02* __this, const RuntimeMethod* method) 
{
	...
	memset((&V_2), 0, sizeof(V_2));
	{
		...
		Vector2_t1FD6F485C871E832B347AB2DC8CBA08B739D8DF7 L_1 = __this->___centerPos_6;
		...
		V_0 = L_4;
		// if (arRaycastManager.Raycast(screenCenterPos, hits, UnityEngine.XR.ARSubsystems.TrackableType.Planes)){
		ARRaycastManager_tD9459374F0F5BD9E2E4A8A1C665E7F33F9C2EE44* L_5 = __this->___arRaycastManager_4;
		Vector2_t1FD6F485C871E832B347AB2DC8CBA08B739D8DF7 L_6 = V_0;
		List_1_t0754071572EFE7A5C92A59495D2524FC935364E3* L_7 = __this->___hits_7;
		NullCheck(L_5);
		bool L_8;
		L_8 = ARRaycastManager_Raycast_mF56A1E2D7CBB61131E4D844ADA9D0CC1F6B53EAC(L_5, L_6, L_7, ((int32_t)15), NULL);
		if (!L_8)
		{
			goto IL_006f;
		}
	...
	}
	{
		...
		List_1_t0754071572EFE7A5C92A59495D2524FC935364E3* L_12 = __this->___hits_7;
		List_1_t0754071572EFE7A5C92A59495D2524FC935364E3* L_13 = __this->___hits_7;
		NullCheck(L_13);
		int32_t L_14;
		...
		L_15 = List_1_get_Item_m443F0D48247776D4257E06597AF794BCF6D8020F(L_12, ((int32_t)il2cpp_codegen_subtract(L_14, 1)), List_1_get_Item_m443F0D48247776D4257E06597AF794BCF6D8020F_RuntimeMethod_var);
		V_1 = L_15;
		Pose_t06BA69EAA6E9FAF60056D519A87D25F54AFE7971 L_16;
		L_16 = ARRaycastHit_get_pose_m84C13E71E21FE12CBA9AAD98DC28B1E414C9EFFD((&V_1), NULL);
...
IL_006f:
	{
		...
		NullCheck(L_18);
		float L_19;
		L_19 = Compass_get_headingAccuracy_mED82316932D27BCF4C30297B3D97169E49A8DBFF(L_18, NULL);
	...
	{
		Compass_t161CD14062E71ED7324FE12ED003EE0877EE546F* L_20;
		L_20 = Input_get_compass_m7DA4657286F9B24D55BB120C9CF761A50B13899B(NULL);
		NullCheck(L_20);
		float L_21;
		L_21 = Compass_get_headingAccuracy_mED82316932D27BCF4C30297B3D97169E49A8DBFF(L_20, NULL);
...
IL_0091:
	{
		...
		((Navigation_t9F99316B323A490310A05E96F2C7460595A0EC02_StaticFields*)il2cpp_codegen_static_fields_for(Navigation_t9F99316B323A490310A05E96F2C7460595A0EC02_il2cpp_TypeInfo_var))->___magneticHeading_8 = L_23;
		...
		NullCheck(L_24);
		float L_25;
		L_25 = Compass_get_trueHeading_m5546F74294A5CC2B4A731ECE1E02F0BE7085582C(L_24, NULL);
		((Navigation_t9F99316B323A490310A05E96F2C7460595A0EC02_StaticFields*)il2cpp_codegen_static_fields_for(Navigation_t9F99316B323A490310A05E96F2C7460595A0EC02_il2cpp_TypeInfo_var))->___trueHeading_9 = L_25;
		// transform.rotation = Quaternion.Euler(transform.rotation.eulerAngles.x, -trueHeading, transform.rotation.eulerAngles.z);
		...
		float L_31 = ((Navigation_t9F99316B323A490310A05E96F2C7460595A0EC02_StaticFields*)il2cpp_codegen_static_fields_for(Navigation_t9F99316B323A490310A05E96F2C7460595A0EC02_il2cpp_TypeInfo_var))->___trueHeading_9;
		...
		L_36 = Quaternion_Euler_m9262AB29E3E9CE94EF71051F38A28E82AEC73F90_inline(L_30, ((-L_31)), L_35, NULL);
		NullCheck(L_26);
		Transform_set_rotation_m61340DE74726CF0F9946743A727C4D444397331D(L_26, L_36, NULL);
	}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void Navigation__ctor_m63EA9B52DBD1B65338196218077F4AF599724AD8 (Navigation_t9F99316B323A490310A05E96F2C7460595A0EC02* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		__this->___hits_7 = L_1;
		Il2CppCodeGenWriteBarrier((void**)(&__this->___hits_7), (void*)L_1);
		MonoBehaviour__ctor_m592DB0105CA0BC97AA1C5F4AD27B12D68A3B7C1E(__this, NULL);
		return;
	}
}
